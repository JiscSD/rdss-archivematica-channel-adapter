...
// messages.
func (c *Consumer) handleMetadataCreateRequest(msg *message.Message) error {
...
// preserved before.
func (c *Consumer) handleMetadataUpdateRequest(msg *message.Message) error {
...
func (c *Consumer) startTransfer(researchObject *message.ResearchObject) (string, error) {
